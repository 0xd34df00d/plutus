...
import           Plutus.ChainIndex.Pagination (Page)
...
handleChainIndexClient event = do
    ...
    case event of
        ...
        UtxoSetAtAddress pq a    -> runClient (getUtxoSetAtAddress $ UtxoAtAddressRequest pq a)
        UtxoSetWithCurrency pq a -> runClient (getUtxoSetWithCurrency $ UtxoWithCurrencyRequest pq a)
